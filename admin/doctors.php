<?php
    ...
    $sql = "SELECT doctors.*, cities.city_name FROM doctors JOIN cities ON doctors.city_id = cities.id";
    ...
    if (isset($_POST['update'])) {
        ...
        header('Location: /WE_assg2/admin/modify_doctors.php');
        exit;
    }
?>
...
<div class="d-flex justify-content-between mb-3">
        <h1>Doctor Table</h1>
        <button class="btn btn-primary" onclick="location.href='add_doctors.php'">Add Doctor</button>
    </div>
